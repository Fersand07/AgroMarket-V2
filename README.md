...
AgroMarket nació como una plataforma de comercio agrícola enfocada en la gestión de usuarios, productos y pedidos. Durante el desarrollo de *AgroMarket V2* se realizaron mejoras significativas tanto en la arquitectura tecnológica como en la experiencia de usuario, incorporando herramientas geoespaciales y nuevas funcionalidades orientadas al sector agrícola.

## Arquitectura Original V1

La versión inicial estaba compuesta por una arquitectura cliente-servidor tradicional.
...
* No existían mapas interactivos.
* No existía geolocalización de usuarios.
* No se podían buscar vendedores cercanos.
* No existía información climática.
* No existía asistencia virtual.
* La estructura de datos limitaba futuras funcionalidades geográficas.

---

## Arquitectura Actual - AgroMarket V2

La plataforma fue rediseñada para incorporar funcionalidades geográficas, mejorar la organización de los datos y ampliar la experiencia del usuario.
...
```text
      ...
      ┌────────────────┼────────────────┐
      ▼                ▼                ▼
 Geolocalización   AgroWeather      AgroHelp
      │            Información      Asistente
      │              Climática       Virtual
      └────────────────┼────────────────┘
                       ▼
              Node.js + Express
...
* Integración visual de mapas y herramientas agrícolas.

### Geolocalización y Mapas

* Registro de ubicación de usuarios.
* Visualización de vendedores en mapas interactivos.
* Búsqueda por cercanía.
* Cálculo de distancias geográficas.
* Cobertura comercial de 15 km.

### AgroWeather

* Consulta de condiciones climáticas en tiempo real.
* Alertas agrícolas basadas en ubicación.

### AgroHelp

* Asistente virtual para orientación de usuarios.
* Ayuda contextual para compradores y vendedores.

### Base de Datos

* Migración de MongoDB a PostgreSQL.
* Integración de Prisma ORM.
* Mejor organización y escalabilidad de la información.
...
AgroMarket evolucionó de una plataforma tradicional de comercio agrícola a una solución moderna que integra geolocalización, información climática, asistencia virtual y herramientas de apoyo para productores y compradores utilizando tecnologías de código abierto.

---

## Funcionalidades Principales

### 1. Widget de Clima Satelital y Alertas de Cultivos (`Smart Farming`)
...
* **Animación 3D interactiva:** Al enfocar el campo del **CVV**, la tarjeta realiza un giro en 3D de 180 grados para revelar la banda magnética y la firma de seguridad trasera de manera fluida. Conectada de forma real con base de datos Neon.
